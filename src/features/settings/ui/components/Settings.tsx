        ...
        <div className='mx-auto max-w-7xl'>
          <div className='grid gap-6 lg:grid-cols-[320px_minmax(0,1fr)]'>
            <motion.aside
              ...
              className='card p-6 max-sm:p-4'
            >
              <div className='flex items-center gap-x-10'>
                <div className='relative'>
                  <div
                    className={`flex-center h-16 w-16 overflow-hidden rounded-full transition-opacity max-sm:h-12 max-sm:w-12 ${
                      profile?.imgUrl
                ...
                <div className='flex-1 lg:w-full'>
                  <h2 className='text-text dark:text-dark-text text-xl font-bold max-sm:text-lg'>
                    {profile?.username || t('profile:noUsername')}
                  </h2>
                  <p className='muted-text text-sm max-sm:text-xs'>
            ...
            <div className='grid grid-cols-1 gap-4 max-sm:gap-3 md:grid-cols-2'>
              {settingsSections.map((section, idx) => (
                <motion.div
                  ...
                  className='card flex h-full p-6 transition-shadow duration-200 hover:shadow-md max-sm:p-4'
                >
                  <div className='flex w-full items-center justify-between gap-x-2 max-sm:flex-col max-sm:items-start max-sm:gap-3'>
                    ...
                    <div className='settings-action max-sm:flex max-sm:w-full max-sm:justify-end'>
                      {renderSectionAction(
